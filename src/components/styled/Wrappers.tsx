...
export const AmountGuestsNumberWrapper = styled.div `
    ...
    border-radius: 2px;
    padding: 0.4rem 0;
    background-color: ${(props: IWrappersNumberOfGuestsProps) => props.selected ? "black" : "none"};
    color: ${(props: IWrappersNumberOfGuestsProps) => props.selected ? "white" : "black"};
    &:hover {
...
export const BookingTimeDivWrapper = styled.div`
    visibility:${(props:IBookingTimeDivWrapperProps) => !props.isAvailable ? "hidden":"visible"};
    width: 100%;
    display: flex;
    flex-direction: row;
    justify-content: space-around;
...
export const BookingTimeWrapper = styled.div`
    ...
    border: 1px solid black;
    border-radius: 2px;
    background-color: ${(props:IWrappersBookingTimeProps)=> props.selected ? "black" : "none"};
